              ...
              if (cartItems[item._id] > 0) {
                return (
                  <div key={index} className='grid grid-cols-[1fr_2fr_1fr_1fr_1fr_0.5fr] items-center text-sm py-4 border-b px-2 hover:bg-gray-50 transition'>
                    ...
                    <p onClick={() => removeFromCart(item._id)} className='cursor-pointer text-red-500 font-bold hover:scale-125 transition w-fit'>x</p>
                  </div>
                )
              }
            })}
        ...
        <div className='mt-20 flex flex-col-reverse md:flex-row justify-between gap-12'>
          <div className='flex-1 flex flex-col gap-5'>
            ...
            <button 
              ...
              className='bg-orange-600 text-white w-full md:w-64 py-3 rounded font-bold hover:bg-orange-700 transition active:scale-95 mt-5'
            >
              PROCEED TO CHECKOUT
            </button>
          </div>
          ...
          <div className='flex-1'>
            ...
            <div className='mt-3 flex items-center bg-gray-100 rounded overflow-hidden'>
              ...
              <button className='bg-gray-800 text-white px-8 py-3 hover:bg-black transition'>Submit</button>
            </div>
          </div>
        </div>
      </div>
