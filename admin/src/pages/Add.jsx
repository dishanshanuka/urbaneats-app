            ...
            <div className='max-w-4xl mx-auto'>
                ...
                <form onSubmit={onSubmitHandler} className='bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 md:p-12 flex flex-col gap-8'>
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <input onChange={onChangeHandler} value={data.name} name='name' className='p-4 bg-gray-50 border-2 border-transparent rounded-2xl outline-none focus:border-orange-500/20 focus:bg-white transition-all font-bold text-gray-700' type="text" placeholder='ENTER DISH NAME' required />
                    </div>

                    <div className="flex flex-col gap-3">
                        <p className='text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]'>Description</p>
                        <textarea onChange={onChangeHandler} value={data.description} name="description" rows="4" className='p-4 bg-gray-50 border-2 border-transparent rounded-2xl outline-none focus:border-orange-500/20 focus:bg-white transition-all font-bold text-gray-600 resize-none' placeholder='WRITE DETAILS ABOUT THE INGREDIENTS...' required></textarea>
                    </div>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
                        ...
                        <div className='flex flex-col gap-3'>
                            ...
                            <div className='relative'>
                                <div className='absolute left-4 top-1/2 -translate-y-1/2 text-[11px] font-black text-orange-600'>LKR</div>
                                <input onChange={onChangeHandler} value={data.price} name='price' className='w-full p-4 pl-14 bg-gray-50 border-2 border-transparent rounded-2xl outline-none focus:border-orange-500/20 focus:bg-white transition-all font-black text-gray-700' type="Number" placeholder='1200' required />
                            </div>
                        </div>
                    </div>
